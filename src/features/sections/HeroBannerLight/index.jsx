...
export const HeroBannerLight = ({data}) => {
  return (
    <section className={styles.wrapper} style={{background: `linear-gradient(0deg, rgba(18, 39, 60, 0.80) 0%, rgba(18, 39, 60, 0.80) 100%), url(${data.bg}) , lightgray 50% / cover no-repeat`,
