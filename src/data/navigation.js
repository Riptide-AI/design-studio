export const navigation = [
  ...
  { title: 'blog', link: '/blog', icon: '/img/linksIcons/blog.svg' },
  { title: 'aboutUs', link: '/about-us', icon: '/img/linksIcons/aboutUs.svg' },
  { title: 'partnership', link: '/partnership', icon: '/img/linksIcons/partners.svg' },
  { title: 'contacts', link: '/contacts', icon: '/img/linksIcons/contacts.svg' },
];
