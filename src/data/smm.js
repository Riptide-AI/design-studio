...
export const socialSMM = {
  ...
  list: [
    {
      title: 'socialSMM.list.1.title',
      desc: 'socialSMM.list.1.desc',
    },
    {
      title: 'socialSMM.list.2.title',
      desc: 'socialSMM.list.2.desc',
    },
    {
      title: 'socialSMM.list.3.title',
      desc: 'socialSMM.list.3.desc',
    },
    {
      title: 'socialSMM.list.4.title',
      desc: 'socialSMM.list.4.desc',
    },
    {
      title: 'socialSMM.list.5.title',
      desc: 'socialSMM.list.5.desc',
    },
    {
      title: 'socialSMM.list.6.title',
      desc: 'socialSMM.list.6.desc',
    },
  ],
...
export const checks = {
  ...
  list: [
    {
      title: 'checks.list.1.title',
      desc: 'checks.list.1.desc',
    },
    {
      title: 'checks.list.2.title',
      desc: 'checks.list.2.desc',
    },
    {
      title: 'checks.list.3.title',
      desc: 'checks.list.3.desc',
    },
    {
      title: 'checks.list.4.title',
      desc: 'checks.list.4.desc',
    },
    {
      title: 'checks.list.5.title',
      desc: 'checks.list.5.desc',
    },
    {
      title: 'checks.list.6.title',
...
export const reviews = {
  ...
  slides: [
    {
      title: 'reviews.smm_slides.1.title',
      author: 'reviews.smm_slides.1.author',
      position: 'reviews.smm_slides.1.position',
      content: 'reviews.smm_slides.1.content',
    },{
      title: 'reviews.smm_slides.2.title',
      author: 'reviews.smm_slides.2.author',
      position: 'reviews.smm_slides.2.position',
      content: 'reviews.smm_slides.2.content',
    },{
      title: 'reviews.smm_slides.3.title',
      author: 'reviews.smm_slides.3.author',
      position: 'reviews.smm_slides.3.position',
      content: 'reviews.smm_slides.3.content',
    },{
      title: 'reviews.smm_slides.4.title',
      author: 'reviews.smm_slides.4.author',
      position: 'reviews.smm_slides.4.position',
      content: 'reviews.smm_slides.4.content',
    },{
      title: 'reviews.smm_slides.5.title',
      author: 'reviews.smm_slides.5.author',
      position: 'reviews.smm_slides.5.position',
      content: 'reviews.smm_slides.5.content',
    },
  ],
};
